      ...
      <div className="w-full mx-auto px-4 sm:max-w-[640px] md:max-w-[768px] lg:max-w-[1024px] xl:max-w-[1280px]">
        <div className="grid" style={{gridTemplateColumns:'repeat(auto-fit, minmax(250px, 1fr))', gap:'32px', marginBottom:'32px'}}>
          ...
          <div>
            ...
            <ul className="list-none p-0 m-0">
              <li className="mb-2"><a className="no-underline" style={{color:'rgba(252,252,250,0.8)', transition:'color 150ms cubic-bezier(0.16,1,0.3,1)'}} href="/privacy" target="_blank">HIPAA Privacy Notice</a></li>
              <li className="mb-2"><a className="no-underline" style={{color:'rgba(252,252,250,0.8)', transition:'color 150ms cubic-bezier(0.16,1,0.3,1)'}} href="/privacy" target="_blank">Privacy Policy</a></li>
              <li className="mb-2"><a className="no-underline" style={{color:'rgba(252,252,250,0.8)', transition:'color 150ms cubic-bezier(0.16,1,0.3,1)'}} href="/terms" target="_blank">Terms of Service</a></li>
